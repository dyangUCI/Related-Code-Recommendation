...
projects collected from GitHub.  We manually inspected a random sample of 50 commonly co-occurring code fragments and found 74\% of them represent relevant functionality that should be included in code search results.
