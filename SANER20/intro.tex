...
fragement of interest~\cite{kim2018Facoy, krugle, searchcode}. 
...
Currently, there is limited understanding about what other kinds of relevant code beyond similar code
...
inspected commonly co-occuring code fragements among similar code.  Using code snippets from Stack Overflow
...
76\% of those common, co-occuring code fragments represented relevant functionality, 
