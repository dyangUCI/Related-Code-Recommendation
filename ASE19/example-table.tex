...
\explanation{
	...
	\begin{itemize}
		\item The recommended related code generates the {\ttt Layout parameters}, it will be traced by {\ttt getLayoutParam} function, which will further be called inside the query method {\ttt onLayout}. There is a dependency chain between the query and the related code.
	\end{itemize}
}
...
\explanation{
	...
	\begin{itemize}
		...
		\item The query snippet from SO uses {\ttt SortedSet} to store the map entries, while the recommended code provides an alternative, using {\ttt LinkedList}, and show how to iterate the map.
	\end{itemize}
}
