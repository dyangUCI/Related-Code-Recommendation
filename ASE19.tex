...
in very large code bases, such as GutHub projects, and then clustering
...
able to find related fragments for \todo{XXX\%} of the queries, and
that \todo{say something more concrete}. A closer look at a set of 30
queries shows that {\tool} has a good precision of \todo{PPP}. This is
a promising result for a new approach to code search. 

\todo{Say something about limitations and future work}
